...
public class TensorFlowImageClassifier implements Classifier{
    ...
    public static Classifier create(AssetManager assetManager,
                                    String modelPath, int inputSize, boolean quant) throws IOException {
    ...
    /*static Classifier create(AssetManager assetManager,
                             ...
                             int inputSize, boolean quant) throws IOException{
    ...
    public List<Recognition> recognizeImage(Bitmap bitmap) {
        ...
        if(quant){
            ...
            byte[][] result = new byte[1][OUTPUT_SIZE];
    ...
    public float[][] recognizeImage(Bitmap bitmap) {
        ByteBuffer byteBuffer = convertBitmapToByteBuffer(bitmap);
        //float[][] result = new float[1][labelList.size()];
        Log.d("bytebuffer:", String.valueOf(byteBuffer));
        float[][] result = new float[1][OUTPUT_SIZE];
        interpreter.run(byteBuffer, result);
        Log.d("float interpreter log:", String.valueOf(result));
        return result;
    }
